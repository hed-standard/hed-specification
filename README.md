...
If you want to annotate your data, please visit the [**HED resources**](https://www.hedtags.org/hed-resources/) documentation website. If you are a developer of a new HED vocabulary (schema) please see the [Schema developer's guide](https://www.hedtags.org/hed-resources/HedSchemaDevelopersGuide.html).
