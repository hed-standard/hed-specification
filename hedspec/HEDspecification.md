...
* [<strong>HED Hierarchical Event Descriptors</strong>](#hed-hierarchical-event-descriptors)
      * [<strong>Third generation specification(HED\-3G)</strong>](#third-generation-specificationhed-3g)
      * [Available under the CC\-BY 4\.0 International license\.](#available-under-the-cc-by-40-international-license)
* [1\. Introduction](#1-introduction)
* [2\. Scope of HED (third generation)](#2-scope-of-hed-third-generation)
  * [2\.1\. Goals of HED](#21-goals-of-hed)
  * [2\.2\. HED design principles](#22-hed-design-principles)
  * [2\.3\. HED terminology](#23-hed-terminology)
      * [Agent\*](#agent)
      ...
      * [Experimental\-participant\*](#experimental-participant)
      * [Experimental\-trial\*](#experimental-trial)
      * [HED schema](#hed-schema)
      * [HED string](#hed-string)
      * [HED tag](#hed-tag)
  ...
  * [2\.4\. The HED schema](#24-the-hed-schema)
    * [2\.4\.1\. Mediawiki format for HED schemas](#241-mediawiki-format-for-hed-schemas)
    * [2\.4\.2\. XML format for a HED schema](#242-xml-format-for-a-hed-schema)
    * [2\.4\.3\. Allowed characters in the HED schema](#243-allowed-characters-in-the-hed-schema)
      * [Table 2\.1\. Rules for valid characters in HED schema\.](#table-21-rules-for-valid-characters-in-hed-schema)
  * [2\.5\. HED vocabulary top\-level organization](#25-hed-vocabulary-top-level-organization)
  * [2\.6\. HED tag syntax and requirements](#26-hed-tag-syntax-and-requirements)
      * [Table 2\.2\. Valid HED tags described by the excerpt of the previous sections\.](#table-22-valid-hed-tags-described-by-the-excerpt-of-the-previous-sections)
* [3\. Annotation using HED tags](#3-annotation-using-hed-tags)
  * [3\.1\. Modeling events as instantaneous occurrences](#31-modeling-events-as-instantaneous-occurrences)
    * [3\.1\.1\. A stimulus event](#311-a-stimulus-event)
    * [3\.1\.2\. Simple specification of task intention](#312-simple-specification-of-task-intention)
    * [3\.1\.3\. A participant action event](#313-a-participant-action-event)
    * [3\.1\.4\. An experimental control event](#314-an-experimental-control-event)
    * [3\.1\.5\. A data feature event](#315-a-data-feature-event)
    * [3\.1\.6\. What else should be documented?](#316-what-else-should-be-documented)
  * [3\.2\. HED definitions and the <em>Definition</em> tag](#32-hed-definitions-and-the-definition-tag)
      * [Table 3\.1\. Syntax for HED definitions\. Optional items are underlined\.](#table-31-syntax-for-hed-definitions-optional-items-are-underlined)
      * [<strong>Table 3\.2\.</strong> Syntax for using definitions in annotations with <em>Def/\.</em>](#table-32-syntax-for-using-definitions-in-annotations-with-def)
  * [3\.3\. Temporal scope](#33-temporal-scope)
    * [3\.3\.1\. <em>Onset</em>/<em>Offset</em> tags to express temporal scope](#331-onsetoffset-tags-to-express-temporal-scope)
      * [<strong>Table 3\.3\.</strong> Syntax for <em>Onset</em> and <em>Offset</em> use with defined names\.](#table-33-syntax-for-onset-and-offset-use-with-defined-names)
    * [3\.3\.2\. <em>Duration</em> as an alternative for expressing temporal scope](#332-duration-as-an-alternative-for-expressing-temporal-scope)
    * [3\.3\.3\. The <em>Delay</em> tag for expressing temporal offsets to current event](#333-the-delay-tag-for-expressing-temporal-offsets-to-current-event)
    * [3\.3\.4\. Validation errors for <em>Onset</em>, <em>Offset</em>, <em>Duration</em>, and <em>Delay</em>](#334-validation-errors-for-onset-offset-duration-and-delay)
  * [3\.4\. The <em>Event\-stream</em> tag](#34-the-event-stream-tag)
  * [3\.5\. The <em>Event\-context</em> tag](#35-the-event-context-tag)
      * [<strong>Table 3\.4\.</strong> Syntax for HED <em>Event\-context</em>\.](#table-34-syntax-for-hed-event-context)
  * [3\.6\. Experimental controls, conditions, and responses](#36-experimental-controls-conditions-and-responses)
  * [3\.7\. Using the <em>Parameter</em> tag to annotate specific information](#37-using-the-parameter-tag-to-annotate-specific-information)
* [4\. HED library schema](#4-hed-library-schema)
  * [4\.1\. Defining a HED library schema](#41-defining-a-hed-library-schema)
  * [4\.2\. Defining a library schema namespace for tagging](#42-defining-a-library-schema-namespace-for-tagging)
  * [4\.3\. Schema attributes and classes in library schemas](#43-schema-attributes-and-classes-in-library-schemas)
  * [4\.4\. Using library schema in BIDS datasets](#44-using-library-schema-in-bids-datasets)
    * [4\.4\.1 Proposed changes for HED library schemas handling in BIDS](#441-proposed-changes-for-hed-library-schemas-handling-in-bids)
* [5\. Behavior of HED tools](#5-behavior-of-hed-tools)
  * [5\.1\. Short\-form and long\-form](#51-short-form-and-long-form)
  * [5\.2\. Event file format (BIDS)](#52-event-file-format-bids)
  * [5\.3\. Event dictionary sidecar format (BIDS)](#53-event-dictionary-sidecar-format-bids)
  * [5\.4\. Levels of validation](#54-levels-of-validation)
    * [5\.4\.1\. HED tag level validation](#541-hed-tag-level-validation)
    * [5\.4\.2\. HED string level validation](#542-hed-string-level-validation)
    * [5\.4\.3\. HED dictionary level validation](#543-hed-dictionary-level-validation)
    * [5\.4\.4\. HED event\-level validation](#544-hed-event-level-validation)
    * [5\.4\.5\. HED recording\-level validation](#545-hed-recording-level-validation)
  * [5\.5\. Behavior in analysis tools](#55-behavior-in-analysis-tools)
  * [5\.6\. HED\-annotated data in BIDS](#56-hed-annotated-data-in-bids)
  * [5\.7\. Mapping old HED tags into third generation HED tags](#57-mapping-old-hed-tags-into-third-generation-hed-tags)
* [Appendices](#appendices)
* [A\. Resources in support of third generation HED](#a-resources-in-support-of-third-generation-hed)
  * [A\.1\. HED documentation and websites](#a1-hed-documentation-and-websites)
      * [Table A\.1\. List of websites containing code and documentation\.](#table-a1-list-of-websites-containing-code-and-documentation)
  * [A\.2\. Schema viewers](#a2-schema-viewers)
      * [<strong>Table A\.2\.</strong> HED web\-based schema vocabulary viewers\.](#table-a2-hed-web-based-schema-vocabulary-viewers)
  * [A\.3\. CTagger for annotating data](#a3-ctagger-for-annotating-data)
  * [A\.4\. HED web\-based services and tools](#a4-hed-web-based-services-and-tools)
      * [Table A\.3\. URLs for accessing HED web\-based tools and services online\.](#table-a3-urls-for-accessing-hed-web-based-tools-and-services-online)
    * [A\.4\.1\. HED web\-based tools](#a41-hed-web-based-tools)
      * [Table A\.4\. Web\-based HED tools currently available\.](#table-a4-web-based-hed-tools-currently-available)
    * [A\.4\.2\. HED web services](#a42-hed-web-services)
      * [Table A\.5\. Summary of available web\-services\.](#table-a5-summary-of-available-web-services)
      * [Table A\.6\. Top\-level JSON parameter dictionary for HED services\.](#table-a6-top-level-json-parameter-dictionary-for-hed-services)
      * [Table A\.7\. Keys in the results dictionary return as part of a HED web service response\.](#table-a7-keys-in-the-results-dictionary-return-as-part-of-a-hed-web-service-response)
  * [A\.5\. HED validation source code](#a5-hed-validation-source-code)
    * [A\.5\.1\. HED validation in python](#a51-hed-validation-in-python)
    * [A\.5\.2\. HED validation in JavaScript](#a52-hed-validation-in-javascript)
      * [A\.5\.2\.1\. Installation](#a521-installation)
      * [A\.5\.2\.2\. Usage](#a522-usage)
      * [A\.5\.2\.3\. Programmatic interface](#a523-programmatic-interface)
    * [A\.5\.3\. HED validation in MATLAB](#a53-hed-validation-in-matlab)
* [B\. HED schema specification and validation](#b-hed-schema-specification-and-validation)
  * [B\.1\. Mediawiki file specification](#b1-mediawiki-file-specification)
    * [B\.1\.1\. The layout of the \.mediawiki file](#b11-the-layout-of-the-mediawiki-file)
    * [B\.1\.2\. The <em>\.mediawiki</em> <em>header\-line</em>](#b12-the-mediawiki-header-line)
      * [<strong>Table B\.1\.</strong> Allowed parameters in the HED schema <em>\.mediawiki</em> header\.](#table-b1-allowed-parameters-in-the-hed-schema-mediawiki-header)
    * [B\.1\.3\. The \_\.mediawiki \_specification format](#b13-the-_mediawiki-_specification-format)
    * [B\.1\.4\. Specification of different schema sections](#b14-specification-of-different-schema-sections)
  * [B\.2\. HED XML format](#b2-hed-xml-format)
    * [B\.2\.1\. The schema node specification](#b21-the-schema-node-specification)
    * [B\.2\.2\. Unit class and unit modifier definitions](#b22-unit-class-and-unit-modifier-definitions)
    * [B\.2\.2\. Value class definitions and behavior](#b22-value-class-definitions-and-behavior)
      * [Table B\.2\. Value classes\.](#table-b2-value-classes)
      * [\* indicates additional syntax checks](#-indicates-additional-syntax-checks)
    * [B\.2\.3\. Schema attribute definitions and properties](#b23-schema-attribute-definitions-and-properties)
      * [Table B\.3\. HED schema attribute properties\.](#table-b3-hed-schema-attribute-properties)
      * [Table B\.4\. HED schema attributes\.](#table-b4-hed-schema-attributes)
      * [Table B\.5\. Deprecated HED schema attributes\.](#table-b5-deprecated-hed-schema-attributes)
    * [B\.2\.5\. HED unit classes and unit modifiers](#b25-hed-unit-classes-and-unit-modifiers)
      * [Table B\.6\. Unit classes for HED\.](#table-b6-unit-classes-for-hed)
      * [Table B\.7\. SI unit modifiers for HED\-3G\.](#table-b7-si-unit-modifiers-for-hed-3g)
  * [B\.3\. HED schema errors](#b3-hed-schema-errors)
    * [B\.3\.1\. General schema errors](#b31-general-schema-errors)
    * [B\.3\.2\. HED format\-specific schema errors\.](#b32-hed-format-specific-schema-errors)
    * [B\.3\.3\. Summary of validation errors for HED schema\.](#b33-summary-of-validation-errors-for-hed-schema)
      * [<strong>Table B\.<strong>9</strong>\.</strong> Validation errors for HED schema\.](#table-b9-validation-errors-for-hed-schema)
* [C\. HED syntax details and validation errors](#c-hed-syntax-details-and-validation-errors)
  * [C\.1\. Valid characters](#c1-valid-characters)
      * [Table C\.1\. Valid characters for various HED elements\.](#table-c1-valid-characters-for-various-hed-elements)
  * [C\.2\. HED validation errors](#c2-hed-validation-errors)
  * [C\.3\. Summary of HED validation errors](#c3-summary-of-hed-validation-errors)
      * [Table C\.2\. Summary of HED validator errors and warnings\.](#table-c2-summary-of-hed-validator-errors-and-warnings)
